...
source("5_scenario_analysis_v4/scenario_inputs/inputs_v4_scenario_analysis_model1.R")$value
#==================================================================================================
...
#write.csv(out1, file = "3_intervention_v4/intervention_outputs/check_manually_.csv") #save the output to a csv file