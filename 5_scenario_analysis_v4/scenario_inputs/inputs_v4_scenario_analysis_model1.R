...
initial_values <- read.csv("5_scenario_analysis_v4/scenario_inputs/inputs - initial_values - for scenario analysis - model1.csv", header = TRUE, stringsAsFactors = FALSE) 
parameters <- read.csv("5_scenario_analysis_v4/scenario_inputs/inputs - parameters_v5 - for scenario analysis - model1.csv", header = TRUE, stringsAsFactors = FALSE) 
...
# min
min_mu_1 <- parameters[parameters$epi_symbol == "mu_1", range_min] 
min_beta_h <- parameters[parameters$epi_symbol == "beta_h", range_min] 
min_sigma_1a <- parameters[parameters$epi_symbol == "sigma_1a", range_min] 
min_sigma_1b <- parameters[parameters$epi_symbol == "sigma_1b", range_min] 
min_gamma_1 <- parameters[parameters$epi_symbol == "gamma_1", range_min] 
min_kappa_1 <- parameters[parameters$epi_symbol == "kappa_1", range_min] 
min_epsilon_1 <- parameters[parameters$epi_symbol == "epsilon_1", range_min] 
min_rho_1 <- parameters[parameters$epi_symbol == "rho_1", range_min]	
min_kappa_h <- parameters[parameters$epi_symbol == "kappa_h", range_min] 
min_tau_h <- parameters[parameters$epi_symbol == "tau_h", range_min] 
min_omega_h <- parameters[parameters$epi_symbol == "omega_h", range_min] 
min_vacc_coverage <- parameters[parameters$epi_symbol == "v_1", range_min] 

# max
max_mu_1 <- parameters[parameters$epi_symbol == "mu_1", range_max] 
max_beta_h <- parameters[parameters$epi_symbol == "beta_h", range_max] 
max_sigma_1a <- parameters[parameters$epi_symbol == "sigma_1a", range_max] 
max_sigma_1b <- parameters[parameters$epi_symbol == "sigma_1b", range_max] 
max_gamma_1 <- parameters[parameters$epi_symbol == "gamma_1", range_max] 
max_kappa_1 <- parameters[parameters$epi_symbol == "kappa_1", range_max] 
max_epsilon_1 <- parameters[parameters$epi_symbol == "epsilon_1", range_max] 
max_rho_1 <- parameters[parameters$epi_symbol == "rho_1", range_max]	
max_kappa_h <- parameters[parameters$epi_symbol == "kappa_h", range_max] 
max_tau_h <- parameters[parameters$epi_symbol == "tau_h", range_max] 
max_omega_h <- parameters[parameters$epi_symbol == "omega_h", range_max] 
max_vacc_coverage <- parameters[parameters$epi_symbol == "v_1", range_max] 
