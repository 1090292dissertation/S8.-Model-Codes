# this script is the model chunk for verification
# define ordinary differential equations here
# treated as input for "1_model outputs checks as per verification checklist.R" script
...
source("2_verification_v4/verification_inputs/inputs_v4_verification_model1.R")$value
#==================================================================================================
...
end1 <- 365*85 #shorter timeframe as we know the model will settle here
...
#write.csv(out1, file = "2_verification_v4/check_equilibrium_verification.csv") #save the output to a csv file